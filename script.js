...
function resetGame() {
  ...
  if (hardMode) {
    noteElement.innerHTML = `Presiona el botón amarillo para comenzar!!
        <p>Modo difícil, evita agujeros negros. ¿Desea volver al modo fácil? Presione E</p>`;
  } else {
    noteElement.innerHTML = `Presiona el botón amarillo para comenzar!!
        <p>Mueva cada bola al centro. ¿Listo para el modo difícil? Presione H</p>`;
  }
